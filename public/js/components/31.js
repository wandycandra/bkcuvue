  ...
  data: function data() {
    return {
      ...
      peran: {
        ...
        jalinan: ['index_anggota_cu', 'index_produk_cu', 'index_jalinan_klaim', 'create_jalinan_klaim', 'update_jalinan_klaim', 'destroy_jalinan_klaim', 'laporan_jalinan_klaim']
      }
    };
  },
  watch: {
